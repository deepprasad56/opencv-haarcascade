...
shoe_cascade =  cv2.CascadeClassifier('shoecascade.xml')
...
while 1:
    ...
    shoe = shoe_cascade.detectMultiScale(gray, 50, 50)
    ...
    for (x,y,w,h) in shoe:
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(img,'Shoe',(x-w,y-h), font, 0.5, (11,255,255), 2, cv2.LINE_AA)
